...
CALL createCityCenterCourt("A", "CITY2", "CENTER", @code);
...
CALL createCity("CITY", @code);
CALL createCityCenter("CENTER", "CITY", @code);
CALL createCityCenterCourt("A", "CITY", "CENTER2", @code);
...
CALL createCity("CITY", @code);
CALL createCityCenter("CENTER", "CITY", @code);
CALL createCityCenterCourt("A", "CITY2", "CENTER2", @code);
/* expected error code CRT-003 */
