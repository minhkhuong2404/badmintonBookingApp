...
public class UnusedCityCenterCourtsHandler extends GetHandler {
    public UnusedCityCenterCourtsHandler(GlobalExceptionHandler exceptionHandler) {
    ...
    private ResponseEntity doGet(InputStream is) throws Exception {
        ...
        ArrayList<Court> ls = SQLStatement.getCityCenterCourts(cityId, centerId);
