...
public class CenterHolidayHandler extends GetHandler {

    public CenterHolidayHandler(GlobalExceptionHandler exceptionHandler) {
    ...
    private ResponseEntity doGet(InputStream is) throws Exception {
        ...
        ArrayList<String> activeHour = SQLStatement.getCenterHoliday("A1");
