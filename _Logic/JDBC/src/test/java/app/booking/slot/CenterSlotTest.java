...
class CenterSlotTest {
    ...
    @Test
    void Construct_GivenDate_Arbitrary() throws Exception {
        // clean up database
        SQLStatement.cleanTable("city");
        SQLStatement.cleanTable("center");
        SQLStatement.cleanTable("staff");
    ...
    @Test
    void Construct_GivenBookings() throws Exception, SQLException, JsonProcessingException {
        // clean up database
        SQLStatement.cleanTable("city");
        SQLStatement.cleanTable("center");
        SQLStatement.cleanTable("staff");
    ...
    @Test
    void Construct_Given_Bookings_Arbitrary() throws Exception {
        // clean up database
        SQLStatement.cleanTable("city");
        SQLStatement.cleanTable("center");
        SQLStatement.cleanTable("staff");
    ...
    @Test
    void Construct_Given_Date_No_Court() throws Exception, SQLException, JsonProcessingException {
        // clean up database
        SQLStatement.cleanTable("city");
        SQLStatement.cleanTable("center");
        SQLStatement.cleanTable("staff");
    ...
    @Test
    void Construct_Given_Date_EmptyBooking_Arbitrary() throws Exception {
        // clean up database
        SQLStatement.cleanTable("city");
        SQLStatement.cleanTable("center");
        SQLStatement.cleanTable("staff");
