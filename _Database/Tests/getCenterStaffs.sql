/* 
[English]
Test guide for: getCenterStaffs(centerId)
- Ensure the database is empty when doing the tests (clean up staff, city, center will let database empty)
...
[Tiếng Việt]
Hướng dẫn kiểm thử cho: getCenterStaffs(centerId)
- Đảm bảo rằng database hoàn toàn trống (xoá dữ liệu trong staff, city, center sẽ làm toàn bộ database trống)
